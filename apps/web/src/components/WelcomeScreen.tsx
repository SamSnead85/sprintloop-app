...
const RECENT_PROJECTS = [
    { id: '1', name: 'my-react-app', path: '/Users/dev/projects/my-react-app', lastOpened: '2 hours ago' },
    { id: '2', name: 'sprintloop-ui', path: '/Users/dev/projects/sprintloop-ui', lastOpened: 'Yesterday' },
    { id: '3', name: 'api-server', path: '/Users/dev/projects/api-server', lastOpened: '3 days ago' },
]

interface WelcomeScreenProps {
    onOpenProject: (path: string, model: AIModel) => void
    onNewProject: (model: AIModel) => void
}

export function WelcomeScreen({ onOpenProject, onNewProject }: WelcomeScreenProps) {
            ...
            <div className="flex-1 flex items-center justify-center p-8">
                <div className="max-w-3xl w-full">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-10">
                        <button
                            onClick={() => onNewProject(selectedModel)}
                        ...
                        <button
                            onClick={() => onOpenProject('', selectedModel)}
                            className="group relative flex items-center gap-4 p-6 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 hover:from-blue-500/20 hover:to-cyan-500/20 border border-blue-500/20 rounded-2xl transition-all"
                        >
                            <div className="w-12 h-12 rounded-xl bg-blue-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                                <FolderOpen className="w-6 h-6 text-blue-400" />
                            </div>
                            <div className="text-left">
                                <h3 className="text-lg font-semibold text-white mb-1">Open Folder</h3>
                                <p className="text-sm text-gray-400">Open an existing project</p>
                            </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-2">
                            {RECENT_PROJECTS.map((project) => (
                                <button
                                    key={project.id}
                                    onClick={() => onOpenProject(project.path, selectedModel)}
